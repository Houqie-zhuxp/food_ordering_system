      ...
      <el-table :data="data.tableData" style="width: 100%">
        ...
        <el-table-column prop="avatar" label="头像">
          <template v-slot="scope">
            <el-image style="width: 50px; height: 50px; border-radius: 50%" v-if="scope.row.avatar" :src="scope.row.avatar"
    ...
    <el-dialog v-model="data.formVisible" title="信息" width="40%" destroy-on-close>
      <el-form :model="data.form" label-width="100px" style="padding-right: 50px">
        ...
        <el-form-item label="性别">
          <el-select style="width: 100%" v-model="data.form.sex">
        ...
        <el-form-item label="头像">
          <el-upload action="http://localhost:9441/files/upload" :on-success="handleFileUpload">
