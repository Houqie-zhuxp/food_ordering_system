<template>
  <div class="login-container">
    <div class="login-box">
      ...
      <div style="font-weight: bold; font-size: 28px; text-align: center; margin-bottom: 30px;">
        <i class="iconfont icon-r-add" style="font-size: 34px;margin-right: 5px;"></i>
        新顾客注册
      </div>
      <el-form :model="data.form" ref="formRef" :rules="data.rules">
        ...
        <el-form-item>
          <el-button size="large" type="success" style="width: 100%" @click="register">注 册</el-button>
        </el-form-item>
      </el-form>
